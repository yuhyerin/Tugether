...
// const selectedFile = this.$route.params.selectedFile
// const myText = this.$route.params.myText
// const urlLink = this.$route.params.urlLink
// const tagNameList = this.$route.params.tagNameList
...
export default {
  ...
  data: function() {
    return {
      ...
      // selectedFile: selectedFile !== undefined ? selectedFile : null,
      // myText: myText !== undefined ? myText : "",
      // urlLink: urlLink !== undefined ? urlLink : "",
      // tagList: [],
      // tagNameList: tagNameList !== undefined ? tagNameList : [],
